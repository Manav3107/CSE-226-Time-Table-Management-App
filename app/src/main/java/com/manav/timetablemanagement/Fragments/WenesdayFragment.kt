...
class WenesdayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_wenesday, container, false)
        ...
        viewModel.getAllTimetables(requireContext(), "Wednesday")?.observe(viewLifecycleOwner, Observer {
            timeTableAdapter.setData(it as ArrayList<Timetable>)
        })

        // Set up the FAB to open the dialog
        view.findViewById<FloatingActionButton>(R.id.fabAddEntryWednesday).setOnClickListener {
            showAddDataDialog()
        }
        return view
    }
